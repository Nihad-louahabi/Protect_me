                    ...
                    <div class="col-lg-10 m-auto">
                        <div class="row">
                                    ...
                                    <div class="padding_eight_all bg-white">
                                        ...
                                        <form method="post" action="{{ route('register') }}">
                                            ...
                                            <div class="form-group">
                                                <input type="text" required="" name="name" placeholder="Nam":value="old('name')" required autofocus autocomplete="name">
                                            </div>
                                            <div class="form-group">
                                                <input type="text" required="" name="email" placeholder="Email" :value="old('email')" required >
                                            </div>
                                            <div class="form-group">
                                                <input type="text" required="" name="phone" placeholder="Télephone" :value="old('phone')" required autocomplete="phone" >
                                            </div>
                                            <div class="form-group">
                                                <input required="" type="password" name="password" placeholder="mot de passe" required autocomplete="new-password">
                                            </div>
                                            <div class="form-group">
                                                <input required="" type="password" name="password_confirmation" placeholder="Confirmer mot de passe" required autocomplete="new-password">
                                            </div>
                            ...
                            <div class="col-6 lg-8">
                               <img src="{{  asset('assets/imgs/register.jpg')">
                            </div>
                        </div>
                    </div>
                </div>
