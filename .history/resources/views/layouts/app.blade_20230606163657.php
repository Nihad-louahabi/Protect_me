...
<body>
    ...
    <header class="">
        ...
        <div class="header-middle header-middle-ptb-1 d-none d-lg-block" id="head">
            <div class="container">
                <div class="header-wrap">
                    <div class="logo logo-width-1">
                        ...
                        <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block">
                            <nav>
                                <ul  class="ml">
                                    ...
                                    <li><img id="c3" src="{{  asset('assets/imgs/logo/c2.jpg')}}"> <a href="{{-- route('shop') --}}">J'adopte</a></li>
                                        ...
                                        <li><a href="#">Mon Compte<i class="fi-rs-angle-down"></i></a>
                                            ...
                                            @else
                                                <ul class="sub-menu">
                                                    ...
                                                    <li><a href="{{-- route('user.orders') --}}">Mes Favoris</a></li>
                                                </ul>
                                            @endif
                                        </li>
                                    @endif
                        ...
                        <div class="header-action-2">
                            ...
                            <div class="header-action-icon-2">
                                <a class="mini-cart-icon" href="cart.html">
                                    <img alt="Protect Me" src="{{  asset('assets/imgs/theme/icons/icon-cart.svg')}}">
