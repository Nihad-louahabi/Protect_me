                        ...
                        <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block">
                            <nav>
                                <ul  class="ml">
                                    ...
                                    <li><img id="c1" src="{{  asset('assets/imgs/logo/c3.jpg')}}"><a href="{{ route('about') }}">About Nous</a></li>
                                    ...
                                    <li class="position-static" ><img id="c7" src="{{  asset('assets/imgs/logo/c8.jpg')}}"><a href="#">Accès rapide
                                        ...
                                        <ul class="mega-menu">
                                            <li class="sub-mega-menu sub-mega-menu-width-50">
                                                ...
                                                <ul>
                                                    <li><a href="{{ route('adopte') }}">Je souhaite adopter un animal</a></li>
                                                    <li><a href="{{ route('user.animal.add') }}">Je dois me séparer de mon animal</a></li>
                                                ...
                                                <div class="menu-banner-wrap">
                                                    ...
                                                    <div class="menu-banner-content">
                                                        ...
                                                        <div class="menu-banner-btn">
                                                            <a href="{{ route('adopte') }}">J'adopte</a>
                                                        </div>
                                                    </div>
                                    ...
                                    @auth
                                        <li><a href="#">Mon Compte<i class="fi-rs-angle-down"></i></a>
                                            @if (Auth::user()->utype == 'ADM')
                                                <ul class="sub-menu">
                                                    <li><a href="{{ route('admin.users') }}">Les Utilisateurs</a></li>
                                            ...
                                            @else
                                                <ul class="sub-menu">
                                                    ...
                                                    <li><a href="{{ route('adopte.wishlist')}}">Mes Favoris</a></li>
                                                </ul>
                                            @endif
                                        </li>
                                    @endif
                ...
                <div class="mobile-menu-wrap mobile-header-border">
                    ...
                    <nav>
                        <ul class="mobile-menu">
                            ...
                            <li class="menu-item-has-children"><span class="menu-expand"></span><a href="{{ route('about') }}">About nous</a></li>
                                <li class="menu-item-has-children"><span class="menu-expand"></span><a href="{{ route('contact') }}">contacter nous</a>
                            </li>
                        </ul>
                    </nav>
                    <!-- mobile menu end -->
            ...
            <div class="row">
                ...
                <div class="col-lg-2 col-md-3">
                    ...
                    <ul class="footer-list wow fadeIn animated mb-sm-5 mb-md-0">
                        ...
                        <li><a href="{{ route('about') }}">About nous</a></li>
                        <li><a href="{{ route('contact') }}">Contactez-nous</a></li>
                    </ul>
                </div>
                <div class="col-lg-2  col-md-3">
                    ...
                    <ul class="footer-list wow fadeIn animated">
                        ...
                        <li><a href="{{ route('adopte.wishlist') }}">Mes Favoris</a></li>
                        <li><a href="{{ route('adopte') }}">J'adobte</a></li>
