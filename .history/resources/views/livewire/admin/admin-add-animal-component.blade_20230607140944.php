                        ...
                        <div class ="card">
                            <div class ="card-header">
                                <div class ="row">
                                    ...
                                    <div class="col-md-6" >
                                        <a href="{{route('admin.animals' )}}" class="btn btn-success float-end">Tous les animaux</a>
                                    </div>
                                </div>
                            </div>
                            <div class ="card-body">
                                ...
                                <form wire:submit.prevent="addAnimal">
                                    ...
                                    <div class="mb-3 mt-3">
                                        ...
                                        <input type="text" class="from-control"  name="phone"  placeholder="Entrez Téléphone " wire:model="phone"></textarea>
                                        @error('phone')
                                            <p class="text-danger">{{$message}}</p>
                                        @enderror
                                    </div>
