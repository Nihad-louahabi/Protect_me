                                ...
                                <div class="row align-items-center slider-animated-1">
                                    <div class="col-lg-5 col-md-6">
                                        <div class="hero-slider-content-2">
                                            ...
                                            <h2 class="animated fw-900">title</h2>
                                            <h1 class="animated fw-900 text-7">sub_title</h1>
                                            <p class="animated">ffre</p>
                                            <a class="animated btn btn-brush btn-brush-2" href=""> Shop Now </a>
                                        </div>
                                    </div>
                                    <div class="col-lg-7 col-md-6">
                                        <div class="single-slider-img single-slider-img-1">
                                            <img class="animated slider-1-1" src="{{asset('assets/imgs/slider')}}"  alt="{{$slide->title}}">
                                    </div>
                                </div>
                            </div>
                        </div>
