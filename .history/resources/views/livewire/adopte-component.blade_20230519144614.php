                                ...
                                <div class="sort-by-cover">
                                    ...
                                    <div class="sort-by-dropdown">
                                        <ul>
                                            ...
                                            <li><a class="{{ $orderBy=='Price: Low to High' ? 'active': '' }}" href="#" wire:click.prevent="changeOrderBy('Price: Low to High')">: Low to High</a></li>
                                ...
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="{{ route('product.details',['slug'=>$animal->slug]) }}">
                                    ...
                                    <div class="product-content-wrap">
                                        ...
                                        <h2><a href="{{ route('product.details',['slug'=>$animal->slug]) }}">{{ $animal->name }}</a></h2>
                            ...
                            @foreach ($nanimals as $nanimal )
                                <div class="single-post clearfix">
                                    ...
                                    <div class="content pt-10">
                                        <h5><a href="{{ route('product.details',['slug'=>$nanimal->slug]) }}">{{ $nanimal->name }}</a></h5>
