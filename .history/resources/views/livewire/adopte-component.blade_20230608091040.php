                                        ...
                                        <div class="product-img-action-wrap">
                                            <div class="product-img product-img-zoom">
                                                <a href="{{ route('animal.details',['slug'=>$animal->slug]) }}">
                                                    <img class="default-img" style="height: 50px;" src="{{asset('assets/imgs/animals')}}/{{ $animal->image }}" alt="{{ $animal->name }}">
                                                </a>
                                            </div>
                                            <div class="product-action-1">
                                                <a aria-label="Quick view" style="width: " class="action-btn hover-up" data-bs-toggle="modal" data-bs-target="#quickViewModal">
