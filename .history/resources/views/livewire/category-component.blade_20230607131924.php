        ...
        <section>
            <div class="single-hero-slider single-animation-wrap">
                <div class="single-slider-img single-slider-img-1">
                     <img style="height: 300px;width: 1400px"  src="{{asset('assets/imgs/slider/slidee.png')}}"  alt="">
                    </div>
                </div>
        </section>
                    ...
                    <div class="col-lg-9">
                        <div class="shop-product-fillter">
                            <div class="totall-product">
                                <p> We found <strong class="text-brand">{{ $animals->total() }}</strong> items for you from <strong class="text-brand">{{ $category_name }}</strong> Category!</p>
                            </div>
                            <div class="sort-by-product-area">
                                ...
                                <div class="sort-by-cover">
                                    ...
                                    <div class="sort-by-dropdown">
                                        <ul>
                                            <li><a class="{{ $orderBy=='Default Sorting' ? 'active': '' }}" href="#" wire:click.prevent="changeOrderBy('Default Sorting')">ri par défaut</a></li>
                                            <li><a class="{{ $orderBy=='Age: Low to High' ? 'active': '' }}" href="#" wire:click.prevent="changeOrderBy('Age: Low to High')">Age: Low to High</a></li>
                                            <li><a class="{{ $orderBy=='Age: High to Low' ? 'active': '' }}" href="#" wire:click.prevent="changeOrderBy('Age: High to Low')">Age: High to Low</a></li>
                                ...
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="{{ route('animal.details',['slug'=>$animal->slug]) }}">
                                                <img class="default-img" src="{{ asset('assets/imgs/shop/product-')}}{{ $animal->id }}-1.jpg" alt="{{ $animal->name }}">
                                                <img class="hover-img" src="{{ asset('assets/imgs/shop/product-')}}{{ $animal->id }}-2.jpg" alt="{{ $animal->name }}">
                                            </a>
                                        </div>
                                    ...
                                    <div class="product-content-wrap">
                                        ...
                                        <div class="product-action-1 show">
                                            <a aria-label="Add To Cart" class="action-btn hover-up" href="#" wire:click.prevent="store({{ $animal->id}},'{{ $animal->name}}',{{ $animal->age}})"><i class="fi-rs-shopping-bag-add"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
