                                        ...
                                        <div class="product-img-action-wrap">
                                            <div class="product-img product-img-zoom">
                                                <a href="{{ route('animal.details',['slug'=>$animal->slug]) }}">
                                                    <img class="default-img" src="{{asset('assets/imgs/animals')}}/{{ $animal->image }}" alt="{{ $animal->name }}">
                                                </a>
                                            </div>
                        ...
                        <div class="sidebar-widget product-sidebar  mb-30 p-30 bg-grey border-radius-10">
                            ...
                            @foreach ($nanimals as $nanimal )
                                <div class="single-post clearfix">
                                    <div class="image">
                                        <img style="height: 300px;width:500px" src="{{ asset('assets/imgs/animals')}}/{{$nanimal->image}}" alt="{{ $nanimal->name }}">
                                    </div>
