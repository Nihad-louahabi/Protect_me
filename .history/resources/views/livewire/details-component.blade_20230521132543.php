                                    ...
                                    <div class="detail-info">
                                        ...
                                        <div class="product-detail-rating">
                                            <div class="pro-details-brand">
                                                <span>Race :  <a href="shop.html">{{ $animal ->race }}</a></span>
                                            </div>
                                        ...
                                        <div class="clearfix ">
                                            <div class="pro-details-brand">
                                                ...
                                                <span ><i class="fa-solid fa-calendar-days" aria-hidden="true">âge : {{ $animal ->age }} Mois </i><span class="text-brand">  {{ $animal ->sexe }}</span></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="detail-extralink">
                                            ...
                                            <div class="product-extra-link2">
                                                <button type="button"  class="button button-add-to-cart" wire:click.prevent="store({{ $animal->id }},'{{ $animal->name }}',{{ $animal->age }})">Add to cart</button>
