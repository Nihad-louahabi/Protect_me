                                    ...
                                    <div class="detail-info">
                                        ...
                                        <div class="detail-extralink">
                                            <div class="product-extra-link2">
                                                ...
                                                <i class="fi fi-rs-phone-call"></i> <button type="button"  class="button button-add-to-cart" wire:click.prevent="store({{ $animal->id }},'{{ $animal->name }}',{{ $animal->age }})">Add to cart</button>
