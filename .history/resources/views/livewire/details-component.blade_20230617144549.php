                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    <div class="detail-info">
                                        ...
                                        <div class="detail-extralink">
                                            ...
                                            </div><div class="product-extra-link2">
                                                <a aria-label="Add To Wishlist" class="action-btn hover-up" href="wishlist.php"><i class="fi-rs-heart"></i></a>
                                                 <button type="button"  class="button button-add-to-cart" wire:click.prevent="sendMail({{ $animal->phone }})">Envoyer Email</button>
                                                <a aria-label="Compare" class="action-btn hover-up" href="compare.php"><i class="fi-rs-shuffle"></i></a><i class="fi-rs-smartphone"></i>
                                            </div>
