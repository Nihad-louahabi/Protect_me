    ...
    <main class="main">
        <section>
            <div class="single-hero-slider single-animation-wrap">
                 <div class="single-slider-img single-slider-img-1">
                    <img style="width: 1400px" src="{{asset('assets/imgs/slider/sliderr.png')}}"  alt="">
                 </div>
             </div>
        ...
        <section >
           <div class="col-lg-7 col-md-6">
                <div class="slid">
                     <img class="slid" src="{{  asset('assets/imgs/slider/slid.jpg')}}">
                    ...
                    <div ><button class="b1"><a>Je donne</a></button>  <button id="b4"><a>J'adopte</a></button></div>
                </div>
            </div>
        </section>
        ...
        <section class="product-tabs section-padding position-relative wow fadeIn animated">
            ...
            <div class="container">
                <div class="tab-header">
                    <a href={{-- "route('shop') --}} class="view-more d-none d-md-flex">Montre plus<i class="fi-rs-angle-double-small-right"></i></a>
                </div>
                <!--End nav-tabs-->
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="banner-img wow fadeIn animated">
                            ...
                            <div class="banner-text">
                                ...
                                <a href="{{-- route('shop') --}}">Adoptez Maintenant <i class="fi-rs-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="banner-img wow fadeIn animated">
                            ...
                            <div class="banner-text">
                                ...
                                <a href="{{-- route('shop') --}}">Adoptez Maintenan<i class="fi-rs-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
