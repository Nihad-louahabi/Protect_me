            ...
            <div class="container">
                <div class="row">
                                    ...
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="{{ route('animal.details',['slug'=>$animal->slug]) }}">
                                                <img class="default-img" src="{{ asset('assets/imgs/products')}}/{{ $animal->image}}" alt="{{$animals->name}}" alt="{{ $animals->name }}">
                                                <img class="hover-img" src="{{ asset('assets/imgs/shop/product-')}}{{ $animal->id }}-2.jpg" alt="{{ $animals->name }}">
                                            </a>
                                        </div>
                    ...
                    <div class="col-lg-3 primary-sidebar sticky-sidebar">
                        ...
                        </div>ss="banner-img wow fadeIn mb-45 animated d-lg-block d-none">
