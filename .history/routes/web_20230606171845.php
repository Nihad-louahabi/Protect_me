...
Route::middleware(['auth','authadmin'])->group(function(){
    ...
    Route::get('/admin/categories',Route::get('/admin/categories',AdminCategoriesComponent::class)->name('admin.categories');
    ...
    Route::get('/admin/animal/edit/{animal_id}',AdminEditAnimalComponent::class)->name('admin.animal.edit');::class)->name('admin.categories');
    Route::get('/admin/category/add',AdminAddCategoryComponent::class)->name('admin.category.add');
    Route::get('/admin/category/edit/{category_id}',AdminEditCategoryComponent::class)->name('admin.category.edit');
    Route::get('/admin/animals}',AdminAnimalComponent::class)->name('admin.animals');
    Route::get('/admin/animal/add}',AdminAddAnimalComponent::class)->name('admin.animal.add');
