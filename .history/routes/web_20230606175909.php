...
Route::middleware(['auth'])->group(function(){
    Route::get('/user/animals}',AdminAnimalComponent::class)->name('admin.animals');
    Route::get('/user/animal/add}',AdminAddAnimalComponent::class)->name('admin.animal.add');
    Route::get('/user/animal/edit/{animal_id}',AdminEditAnimalComponent::class)->name('admin.animal.edit');
