                        ...
                        <div class ="card">
                            <div class ="card-header">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <a href="{{route('user.animal.add')}} "class="btn btn-success float-end">Ajouter Animal</a>
                                    </div>
                            </div>
                            <div class ="card-body">
                                ...
                                <table class="table tabel-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a  href="{{route('user.animal.edit',['animal_id'=>$animal->id])}}" class="text-info">Modifier</a>
